...
public class EmployeeCardRunner {
	...
	public static void main(String[] args) {
		...
		try {
			...
			list.add(new EmployeeCard(1,"Tesla Model S", "Tesla", 1234567890L, 22.5f, 100.0, true, 'E',customDate1, 5));
			list.add(new EmployeeCard(2,"Honda Accord", "Honda", 1234567891L, 20.0f, 2500.0, false, 'P', customDate2, 5));
			list.add(new EmployeeCard(3,"BMW i8", "BMW", 1234567892L, 18.5f, 1500.0, true, 'E', customDate3, 4));
			list.add(new EmployeeCard(4,"Audi Q7","Audi", 1234567893L, 14.5f, 3000.0, false, 'P',customDate4, 7));
			list.add(new EmployeeCard(5,"Mercedes-Benz GLC","Mercedes-Benz", 1234567894L, 16.0f, 2000.0, false, 'P',customDate5, 5));
			list.add(new EmployeeCard(6,"Porsche Taycan","Porsche", 1234567895L, 20.0f, 930.0, true, 'E',customDate6, 4));
			list.add(new EmployeeCard(7,"Honda Jazz", "Honda", 1234567896L, 20.0f, 2500.0, false, 'P', customDate7, 5));
			for(EmployeeCard vt:list)
