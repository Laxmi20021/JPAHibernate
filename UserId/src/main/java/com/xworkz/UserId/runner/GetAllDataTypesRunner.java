...
public class GetAllDataTypesRunner {
	...
	public static void main(String[] args) {
		...
		query2.setParameter("byId",2).setParameter("bylModelName", "Honda Accord");
		...
		query3.setParameter("byId",3).setParameter("bylModelName", "BMW i8");
		...
		query4.setParameter("byId",4).setParameter("bylModelName", "Audi Q7");
		...
		query5.setParameter("byId",5).setParameter("bylModelName", "Mercedes-Benz GLC");
		...
		query6.setParameter("byId",6).setParameter("bylModelName", "Porsche Taycan");
		...
		query7.setParameter("byId",1).setParameter("bylModelName", "Tesla Model S");
